...
const Mbti =  (()=> {
  ...
  {q:['내일까지 맛있는 치킨에 대해','발표 준비 해 오세요.'],
   ...
   {q:['나와~~ 술 한잔 하자~'],
    ...
    {q:['나 배 아파ㅠㅠ'],
    a:[{type:'T',text:'오늘 뭐 먹었는데?'},{type:'F',text:'많이 아파? 약은 먹었어?'}]},
    {q:['나 스마트폰 떨어트렸어;;'],
    a:[{type:'T',text:'잉? 뭐하다가 떨어트림?'},{type:'F',text:'헐 액정은 무사해? 괜찮아?'}]},
   ...
   {q:['나 오늘 지각해서 부장님한테 깨졌어...'],
    ...
    {q:['하 스트레스 받아. 술이나 마시자'],
    a:[{type:'F',text:'왜 그래 무슨 일 있어?!'},{type:'T',text:'그래. 뭐먹을래?'}]},
   ...
   {q:['갑자기 일이 생겨서','오늘 못 만날 것 같아ㅠㅠ'],
    ...
    {q:['너가 장바구니에 넣어 놓은 옷 별로야'],
    a:[{type:'N',text:'이쁜데?? (구매한다)'},{type:'S',text:'그래?? (구매하지 않는다)'}]},
    {q:['자 지금부터 5분동안 아무 생각 하지않기','시작!'],
    a:[{type:'S',text:'진짜 생각 안함 or 생각 하지 말자... 정도 생각함'},
       {type:'N',text:'근데 죽으면 아무 생각도 하지 않게 되는걸까? 아님 몸은 죽고 영혼은 살아 계속 생각을 하고있을까...?'}]},
   ...
   {q:['<강아지는 야옹> 시험에 나온대.'],
    a:[{type:'S',text:'잉? 뭐 시험에 나온다니 일단 외워야지;;'},{type:'N',text:'왜? 왜지? 강아지가 왜 야옹? 도대체 왜?'}]},
    {q:['저녁 먹었어??'],
    a:[{type:'N',text:'(앗 밥 안먹었나? 그래서 같이 먹자는건가??)'},{type:'S',text:'(궁금한가보네) 응 먹었어~'}]},


    
   
  
    {q:['난 사과보다 레몬이 더 맛있는 것 같아ㅋㅋ'],
    a:[{type:'F',text:'(난 사과가 더 좋긴하지만) 레몬 맛있지~~'},{type:'T',text:'난 사과가 더 맛있던데?'}]},
