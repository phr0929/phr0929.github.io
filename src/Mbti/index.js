...
import ENTP from '../resource/istp.svg'
import INTP from '../resource/istp.svg'
import ESFJ from '../resource/istp.svg'
import ISFJ from '../resource/istp.svg'
import ESTP from '../resource/istp.svg'
import ISTP from '../resource/istp.svg'
import ENFJ from '../resource/istp.svg'
import INFJ from '../resource/istp.svg'
import ESFP from '../resource/istp.svg'
import ISFP from '../resource/istp.svg'
import ENTJ from '../resource/istp.svg'
import INTJ from '../resource/istp.svg'
import ENFP from '../resource/istp.svg'
import INFP from '../resource/istp.svg'
import ESTJ from '../resource/istp.svg'
import ISTJ from '../resource/istp.svg'
...
useEffect(()=>{
  ...
  function setMbti() {
    ...
    let mc = [
      {mbti:'ENTP',img:ENTP,contents:'ㅇㅇㅇㅇ',bookmark:[{mbti:'ENFJ',img:ENFJ,relationship:'ㅇㅇ'},{mbti:'ENTJ',img:ENTJ,relationship:'ㅇㅇ'}]},
      {mbti:'INTP',img:INTP,contents:'ㅇㅇㅇㅇ',bookmark:[{mbti:'ENFJ',img:ENFJ,relationship:'ㅇㅇ'},{mbti:'ENTJ',img:ENTJ,relationship:'ㅇㅇ'}]},
      {mbti:'ESFJ',img:ESFJ,contents:'ㅇㅇㅇㅇ',bookmark:[{mbti:'ENFJ',img:ENFJ,relationship:'ㅇㅇ'},{mbti:'ENTJ',img:ENTJ,relationship:'ㅇㅇ'}]},
      {mbti:'ISFJ',img:ISFJ,contents:'ㅇㅇㅇㅇ',bookmark:[{mbti:'ENFJ',img:ENFJ,relationship:'ㅇㅇ'},{mbti:'ENTJ',img:ENTJ,relationship:'ㅇㅇ'}]},
      {mbti:'ESTP',img:ESTP,contents:'ㅇㅇㅇㅇ',bookmark:[{mbti:'ENFJ',img:ENFJ,relationship:'ㅇㅇ'},{mbti:'ENTJ',img:ENTJ,relationship:'ㅇㅇ'}]},
      {mbti:'ISTP',img:ISTP,contents:'ㅇㅇㅇㅇ',bookmark:[{mbti:'ENFJ',img:ENFJ,relationship:'ㅇㅇ'},{mbti:'ENTJ',img:ENTJ,relationship:'ㅇㅇ'}]},
      {mbti:'ENFJ',img:ENFJ,contents:'ㅇㅇㅇㅇ',bookmark:[{mbti:'ENFJ',img:ENFJ,relationship:'ㅇㅇ'},{mbti:'ENTJ',img:ENTJ,relationship:'ㅇㅇ'}]},
      {mbti:'INFJ',img:INFJ,contents:'ㅇㅇㅇㅇ',bookmark:[{mbti:'ENFJ',img:ENFJ,relationship:'ㅇㅇ'},{mbti:'ENTJ',img:ENTJ,relationship:'ㅇㅇ'}]},
      {mbti:'ESFP',img:ESFP,contents:'ㅇㅇㅇㅇ',bookmark:[{mbti:'ENFJ',img:ENFJ,relationship:'ㅇㅇ'},{mbti:'ENTJ',img:ENTJ,relationship:'ㅇㅇ'}]},
      {mbti:'ISFP',img:ISFP,contents:'ㅇㅇㅇㅇ',bookmark:[{mbti:'ENFJ',img:ENFJ,relationship:'ㅇㅇ'},{mbti:'ENTJ',img:ENTJ,relationship:'ㅇㅇ'}]},
      {mbti:'ENTJ',img:ENTJ,contents:'ㅇㅇㅇㅇ',bookmark:[{mbti:'ENFJ',img:ENFJ,relationship:'ㅇㅇ'},{mbti:'ENTJ',img:ENTJ,relationship:'ㅇㅇ'}]},
      {mbti:'INTJ',img:INTJ,contents:'ㅇㅇㅇㅇ',bookmark:[{mbti:'ENFJ',img:ENFJ,relationship:'ㅇㅇ'},{mbti:'ENTJ',img:ENTJ,relationship:'ㅇㅇ'}]},
      {mbti:'ENFP',img:ENFP,contents:'ㅇㅇㅇㅇ',bookmark:[{mbti:'ENFJ',img:ENFJ,relationship:'ㅇㅇ'},{mbti:'ENTJ',img:ENTJ,relationship:'ㅇㅇ'}]},
      {mbti:'INFP',img:INFP,contents:'ㅇㅇㅇㅇ',bookmark:[{mbti:'ENFJ',img:ENFJ,relationship:'ㅇㅇ'},{mbti:'ENTJ',img:ENTJ,relationship:'ㅇㅇ'}]},
      {mbti:'ESTJ',img:ESTJ,contents:'ㅇㅇㅇㅇ',bookmark:[{mbti:'ENFJ',img:ENFJ,relationship:'ㅇㅇ'},{mbti:'ENTJ',img:ENTJ,relationship:'ㅇㅇ'}]},
      {mbti:'ISTJ',img:ISTJ,contents:'ㅇㅇㅇㅇ',bookmark:[{mbti:'ENFJ',img:ENFJ,relationship:'ㅇㅇ'},{mbti:'ENTJ',img:ENTJ,relationship:'ㅇㅇ'}]}
    ]
