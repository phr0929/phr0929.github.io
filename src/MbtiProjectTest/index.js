...
const Mbti =  (()=> {
  ...
  const questionList = [
    ...
    {q:['오늘 점심 뭐 먹을래?'],
     a:[{type:'N',text:'파스타 먹을까? 아! 파스타 먹으면 느끼하니까 저녁엔 김치찌개를 먹어야겠다!'},
    ...
    {q:['슬픔을 나누면 어떻게 될까?'],
    a:[{type:'T',text:'슬픈 사람이 둘이 되겠지'},
       {type:'J',text:'시험이 2주밖에 안남았네. 이틀에 한과목씩은 끝내놔야겠다.'}]},

    {q:['나 시험에서 떨어졌어...ㅠㅠ'],
     a:[{type:'T',text:'무슨 시험 봤는데? 몇점 받았는데?'},{type:'F',text:'아고, 많이 속상하겠다ㅠㅠ'}]},
